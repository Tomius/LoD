...
public:
  Ayumi(Skybox& skybox)
    ...
    mesh.add_animation("models/ayumi_idle.dae", "Stand",
                       oglwrap::AnimFlag::Repeat |
                       oglwrap::AnimFlag::Interruptable);

    mesh.add_animation("models/ayumi_walk.dae", "Walk",
                       oglwrap::AnimFlag::Repeat |
                       oglwrap::AnimFlag::Interruptable);

    mesh.add_animation("models/ayumi_run.dae", "Run",
                       oglwrap::AnimFlag::Repeat |
                       oglwrap::AnimFlag::Interruptable);

    mesh.add_animation("models/ayumi_jump_rise.dae", "JumpRise",
                       oglwrap::AnimFlag::MirroredRepeat |
                       oglwrap::AnimFlag::Interruptable);

    mesh.add_animation("models/ayumi_jump_fall.dae", "JumpFall",
                       oglwrap::AnimFlag::MirroredRepeat |
                       oglwrap::AnimFlag::Interruptable);

    mesh.add_animation("models/ayumi_attack.dae", "Attack",
  ...
  void render(float time,
    ...
    if(sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
      ...
      if(charmove.is_jumping_rise()) {
        ...
        mesh.set_current_animation("JumpFall", time, 0.5f);
      }
