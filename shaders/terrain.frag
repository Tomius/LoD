...
void main() {
  ...
  vec3 grass10_color = texture2D(uGrassMap0, grass_texcoord/12).rgb;
  vec3 grass11_color = texture2D(uGrassMap1, grass_texcoord/12).rgb;
  ...
  vec3 grass_color = mix(grass_color0, grass_color1, 0.4);
